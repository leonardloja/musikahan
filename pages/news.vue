<template>
  <div class="overflow-hidden bg-white">
    <div class="relative mx-auto max-w-7xl py-16 px-6 lg:px-8">
      ...
      >
        <div>
          <h2 class="text-lg font-semibold text-indigo-600">February 16</h2>
          <h3
            ...
            <figure>
              <div class="aspect-w-12 aspect-h-7 lg:aspect-none">
                <img
                  ...
                  src="https://images.unsplash.com/photo-1458560871784-56d23406c091?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1548&q=80"
